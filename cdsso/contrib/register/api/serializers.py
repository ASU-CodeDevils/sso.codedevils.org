...
class SlackUserProfileSerializer(serializers.Serializer):
    ...
    image_original = serializers.CharField()
    is_custom_image = serializers.BooleanField()
    email = serializers.CharField(required=True)
    first_name = serializers.CharField()
    last_name = serializers.CharField()
    image_24 = serializers.CharField()
    image_32 = serializers.CharField()
    image_48 = serializers.CharField()
    image_72 = serializers.CharField()
    image_192 = serializers.CharField()
    image_512 = serializers.CharField()
    image_1024 = serializers.CharField()
