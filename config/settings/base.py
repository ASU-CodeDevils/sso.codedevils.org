...
FLAMEBOI_API_USERNAME = env("CDSSO_FLAMEBOI_API_USERNAME")
FLAMEBOI_API_PASSWORD = env("CDSSO_FLAMEBOI_API_PASSWORD")
REGISTER_SLACK_USERS_WITH_FLAMEBOI = env.bool(
    "CDSSO_REGISTER_SLACK_USERS_WITH_FLAMEBOI", default=True
)
REGISTRATION_PAGINATION = env.int(
    "CDSSO_REGISTRATION_PAGINATION", default=100
)
